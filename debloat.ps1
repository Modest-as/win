...
Function DebloatAll {
    ...
    $WhitelistedApps = 'Microsoft.WindowsCalculator|Microsoft.WindowsStore|Microsoft.Windows.Photos|.NET|Framework'
...
Function FixWhitelistedApps {
    ...
    If (!(Get-AppxPackage -AllUsers | Select Microsoft.WindowsCalculator, Microsoft.WindowsStore, Microsoft.Windows.Photos)) {
